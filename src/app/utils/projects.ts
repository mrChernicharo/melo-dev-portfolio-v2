...
import { gordinhoPix, lacosPix, oldPortPix, pathPix, videoURLs } from "./helpers";
...
const pathTechs: SkillNames[] = ["React", "Typescript", "tailwind"];
...
export const projects: IProject[] = [
  ...
  },
  {
    ...
    description:
      "Visualization tool for the A* pathfinding algorithm. With an intuitive user interface, it allows users to interactively explore and understand the algorithm's behavior. By inputting a start and end point, as well as obstacles, the app dynamically calculates the shortest path using A* and highlights the nodes visited",
    links: {
      github: "https://github.com/mrChernicharo/path-finder-app",
      www: "https://bright-dodol-9bedc7.netlify.app/",
    },
    techs: getTechs(pathTechs),
		imageUrls: pathPix,
    videoUrl: videoURLs.pathFinder
  },
  {
    id: "mel",
  ...
  },
  {
    ...
    links: {
      github: "https://github.com/mrChernicharo/happy-plants",
      www: null,
    },
    imageUrls: [],
  },
